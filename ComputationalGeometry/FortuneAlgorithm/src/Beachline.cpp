...
Arc* Beachline::locateArcAbove(const myVector2& point, double l) const
{
    Arc* node = mRoot;
    bool found = false;
    while (!found)
...
double Beachline::computeBreakpoint(const myVector2& point1, const myVector2& point2, double l) const
{
