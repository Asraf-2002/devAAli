...
public:
    ...
    FortuneAlgorithm(std::vector<myVector2> points);
    ~FortuneAlgorithm();
...
private:
    ...
    myVector2 computeConvergencePoint(const myVector2& point1, const myVector2& point2, const myVector2& point3, double& y) const;
